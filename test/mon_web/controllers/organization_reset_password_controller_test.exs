defmodule MonWeb.OrganizationResetPasswordControllerTest do
  ...
  describe "POST /organizations/reset_password" do
    ...
    test "sends a new reset password token", %{conn: conn, organization: organization} do
      ...
      assert Repo.get_by!(Accounts.OrganizationToken, organization_id: organization.id).context == "reset_password"
    end
