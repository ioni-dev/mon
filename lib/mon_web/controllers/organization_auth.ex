defmodule MonWeb.OrganizationAuth do
  import Plug.Conn
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "organization_remember_me"
  ...
  def log_out_organization(conn) do
    ...
    organization_token && Accounts.delete_session_token(organization_token)
  ...
  def fetch_current_organization(conn, _opts) do
    ...
    organization = organization_token && Accounts.get_organization_by_session_token(organization_token)
  ...
  defp maybe_store_return_to(%{method: "GET"} = conn) do
    ...
    put_session(conn, :organization_return_to, return_to)
  end
